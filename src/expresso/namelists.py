...
class SystemNamelist(Namelist):
    ...
    celldm: List[float] = attrib(converter=List[float], default=0.0)
    ...
    starting_charge: List[float] = attrib(converter=List[float], default=0.0)
    tot_magnetization: float = attrib(converter=float, default=-1.0)
    starting_magnetization: List[float] = attrib(converter=List[float], default=0.0)
    ...
    Hubbard_U: List[float] = attrib(converter=List[float], default=0.0)
    Hubbard_J0: List[float] = attrib(converter=List[float], default=0.0)
    Hubbard_alpha: List[float] = attrib(converter=List[float], default=0.0)
    Hubbard_beta: List[float] = attrib(converter=List[float], default=0.0)
    Hubbard_J: List[float] = attrib(converter=List[float], default=0.0)
    ...
    angle1: List[float] = attrib(converter=List[float], default=0.0)
    angle2: List[float] = attrib(converter=List[float], default=0.0)
    constrained_magnetization: str = attrib(converter=str, default='none')
    fixed_magnetization: List[float] = attrib(converter=List[float], default=0.0)
    ...
    london_c6: List[float] = attrib(converter=List[float], default=0.0)
    london_rvdw: List[float] = attrib(converter=List[float], default=0.0)
